...
- **CRDCSearch2CodeMap.py** - Converts the CRDC Search JSON model file to CodeMap spreadsheet format (DEPRECATED)
- **CRDCXLXS2CodeMap.py** - Converts the CRDC Search Excel file to CodeMap spreadsheet format (DEPRECATED)
