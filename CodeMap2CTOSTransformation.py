...
def main(args):
    ...
    if configs['include_model_names']:
        field_mapping = {"Source Model Name": "lift_from_model", "Source Model Version": "lift_from_version", "Source Element": "lift_from_node", "Source Characteristic": "lift_from_property", "Target Model": "lift_to_model", "Target Model Version": "lift_to_version",
    ...
    # If asked for, drop any rows with a blank lift_from_property
